    ...
    def self.available_options
      ...
      [
        ...
        FastlaneCore::ConfigItem.new(key: :overwrite_screenshots,
                                     ...
                                     is_string: false,
                                     default_value: false),
        FastlaneCore::ConfigItem.new(key: :overwrite_previews,
                                     env_name: "DELIVER_OVERWRITE_PREVIEWS",
                                     description: "Clear all previously uploaded previews before uploading the new ones",
                                     is_string: false,
                                     default_value: false),
